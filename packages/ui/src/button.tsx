...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary: "bg-[#7b65c1] text-white shadow hover:bg-[#7b65c1]/90",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "transtion-all border border-white px-4 py-2 text-sm font-medium duration-300 ease-in-out hover:bg-white hover:text-black",
        secondary:
